...
const SOURCE_DOMAIN = "https://anime-sama.fr/"

export class AngelFrench Repo extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Angel French Repo' }
    get description(): string { return 'Anime Sama french scan website' }
    get author(): string { return 'Angel' }
    get authorWebsite(): string { return 'Anime Sama' }
